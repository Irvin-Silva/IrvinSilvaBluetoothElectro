package com.IrvinSilva.bluetoothconn;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final static int CONNECTING_STATUS = 1; // used hhandler to identify message status
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (deviceName != null){
            ...
            toolbar.setSubtitle("Conectando a:  " + deviceName + "...");
            ...
            public void handleMessage(Message msg){
                switch (msg.what){
                    ...
                    case MESSAGE_READ:
                        ...
                        // ESTA ES UNA DE LAS PARTES MÁS IMPORTANTES DEL CÓDIGO,
                        // YA QUE LEE LOS DATOS DEL ARDUINO Y REALIZA LOS CAMBIOS EN LA APP
